...
:material-star-four-points: *Underlined authors are SAGE Lab members.* :material-arrow-down: Click on a paper title to expand the details.
...
???+ tip "\[ICSE'23\] - AidUI: Toward Automated Recognition of Dark Patterns in User Interfaces"
...
???+ tip "\[TestEd'23\] - ChatGPT and Software Testing Education: Promises & Perils"
...
???+ example "\[ICSE'23 Demo\] - BURT: A Chatbot for Interactive Bug Reporting"
...
???+ example "\[ICSE'23 Demo\] - AVGUST: A Tool for Generating Usage-Based Tests from Videos of App Executions"
...
??? tip "\[ESEC/FSE'22\] - AVGUST: Automating Usage-based Test Generation from Videos of App Executions"
...
??? tip "\[ESEC/FSE'22\] - Toward Interactive Bug Reporting for (Android App) End Users"
...
??? note "\[TSE'22\] - Enhancing Mobile App Bug Reporting via Real-time Understanding of Reproduction Steps"
...
??? note "\[TSE'22\] - Translating Video Recordings of Complex Mobile App UI Gestures into Replayable Scenarios for Native & Hybrid Apps"
...
??? tip "\[Computational UI@CHI'22\] - Learning Patterns from User Interfaces to Support Software Engineering Tasks"
...
??? tip "\[SANER'22\] - An Empirical Investigation into the Use of Image Captioning for Automated Software Documentation"
...
??? tip "\[SANER'22\] - An Empirical Investigation into the Reproduction of Bug Reports for Android Apps"
...
??? note "\[TOSEM'22\] - A Systematic Literature Review on the Use of Deep Learning in Software Engineering Research - TOSEM'22"
...
??? tip "\[Oakland'22\] - Why Crypto-detectors Fail: A Systematic Evaluation of Cryptographic Misuse Detection Techniques"
...
??? tip "\[NLP4Prog'21\] - Code to Comment Translation: A Comparative Study on Model Effectiveness & Errors"
...
??? abstract "\[MSR Data Showcase'21\] - AndroR2: A Dataset of Manually-Reproduced Bug Reports for Android Apps"
...
??? tip "\[ICSE'21\] - It Takes Two to Tango: Combining Visual and Textual Information for Detecting Duplicate Video-Based Bug Reports"
...
??? example "\[ICSE'21 Demo\] - V2S: A Tool for Translating Video Recordings of Mobile App Usages into Replayable Scenarios"
...
??? example "\[ICSE'21 Demo\] - Mutation-based Evaluation of Security-focused Static Analysis Tools for Android"
...
??? note "\[TOPS'21\] - Systematic Mutation-based Evaluation of the Soundness of Security-focused Android Static Analysis Techniques"
...
??? note "\[TCPS'21\] - Security in Centralized Data Store-based Home Automation Platforms: A Systematic Analysis of Nest and Hue"

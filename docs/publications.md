...
???+ tip "AidUI: Toward Automated Recognition of Dark Patterns in User Interfaces - ICSE'23"
...
???+ tip "ChatGPT and Software Testing Education: Promises & Perils - TestEd'23"
...
???+ example "BURT: A Chatbot for Interactive Bug Reporting - ICSE'23 Demo"
...
???+ example "AVGUST: A Tool for Generating Usage-Based Tests from Videos of App Executions - ICSE'23 Demo"
...
??? tip "AVGUST: Automating Usage-based Test Generation from Videos of App Executions - ESEC/FSE'22"
...
??? tip "Toward Interactive Bug Reporting for (Android App) End Users - ESEC/FSE'22"
...
??? note "Enhancing Mobile App Bug Reporting via Real-time Understanding of Reproduction Steps - TSE'22"
...
??? note "Translating Video Recordings of Complex Mobile App UI Gestures into Replayable Scenarios for Native & Hybrid Apps - TSE'22"
...
??? tip "Learning Patterns from User Interfaces to Support Software Engineering Tasks - Computational UI@CHI'22"
...
??? tip "An Empirical Investigation into the Use of Image Captioning for Automated Software Documentation - SANER'22"
...
??? tip "An Empirical Investigation into the Reproduction of Bug Reports for Android Apps - SANER'22"
...
??? note "A Systematic Literature Review on the Use of Deep Learning in Software Engineering Research - TOSEM'22"
...
??? tip "Why Crypto-detectors Fail: A Systematic Evaluation of Cryptographic Misuse Detection Techniques - Oakland'22"
...
??? tip "Code to Comment Translation: A Comparative Study on Model Effectiveness & Errors - NLP4Prog'21"
...
??? abstract "AndroR2: A Dataset of Manually-Reproduced Bug Reports for Android Apps - MSR'21 Data Showcase"
...
??? tip "It Takes Two to Tango: Combining Visual and Textual Information for Detecting Duplicate Video-Based Bug Reports - ICSE'21"
...
??? example "V2S: A Tool for Translating Video Recordings of Mobile App Usages into Replayable Scenarios - ICSE'21 Demo"
...
??? example "Mutation-based Evaluation of Security-focused Static Analysis Tools for Android - ICSE'21 Demo"
...
??? note "Systematic Mutation-based Evaluation of the Soundness of Security-focused Android Static Analysis Techniques - TOPS'21"
...
??? note "Security in Centralized Data Store-based Home Automation Platforms: A Systematic Analysis of Nest and Hue - TCPS'21"
